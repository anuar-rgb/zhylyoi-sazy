  ...
  return (
    <div className={`flex items-center gap-1 text-xs font-semibold ${className}`}>
      <Link
        href={pathname}
        locale="kk"
        className={`px-2 py-1 rounded transition-colors ${locale === "kk" ? "bg-gold text-darkred" : "text-cream/70 hover:text-gold"}`}
      >
        ҚАЗ
      </Link>
      ...
      <Link
        href={pathname}
        locale="ru"
        className={`px-2 py-1 rounded transition-colors ${locale === "ru" ? "bg-gold text-darkred" : "text-cream/70 hover:text-gold"}`}
      >
        РУС
      </Link>
    </div>
