    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <a
          ...
          rel="noopener noreferrer"
          aria-label="Telegram"
          className="w-10 h-10 rounded-full bg-[#26A5E4] text-white flex items-center justify-center hover:opacity-90 transition-opacity"
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d="M21.05 3.16 2.9 10.26c-1.24.5-1.23 1.19-.23 1.5l4.65 1.45 1.8 5.47c.22.6.36.84.74.84.31 0 .46-.14.65-.32l1.77-1.7 4.02 2.97c.74.41 1.27.2 1.46-.68l2.64-12.48c.28-1.15-.42-1.66-1.35-1.15Z" />
          </svg>
        </a>
        <button
          type="button"
