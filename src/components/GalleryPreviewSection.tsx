        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8">
          ...
          <FadeIn className="lg:col-span-2">
            <div className="h-full flex flex-col">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gold/90 group-hover:bg-gold flex items-center justify-center transition-all group-hover:scale-110 shadow-xl">
                        <svg className="w-6 h-6 sm:w-7 sm:h-7 text-ocean ml-0.5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href="/video"
                className="mt-4 inline-flex items-center justify-center gap-1.5 text-sm font-semibold text-ocean hover:text-gold-dark transition-colors"
              >
                {t.watchAll}
